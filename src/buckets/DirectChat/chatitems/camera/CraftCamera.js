...
function CraftCamera(props) {
  ...
  // iOS width and height are reveresed as its camera sensors work that way. So, flip the things.
...
export default connect(mapStateToProps)(CraftCamera);
