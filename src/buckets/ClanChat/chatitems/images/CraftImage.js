  ...
  return (
    <View style={overall_view_wrap}>
      ...
      <ViewShot
        ...
        <FastImage style={image_style} source={{uri: props.imagePicked}}>
          <Draggable
            children={Children()}
            x={0}
            y={windowWidth * 0.7}
...
export default connect(mapStateToProps)(CraftImage);
